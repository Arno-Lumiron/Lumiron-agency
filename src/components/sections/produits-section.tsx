  ...
  return (
    <section id="produits" className="py-17.5 bg-ivoire" aria-labelledby="produits-heading">
      <div className="max-w-7xl mx-auto px-5 md:px-10">
        ...
        {/* Extras bar */}
        <AnimatedReveal delay={200} className="mt-8 p-6 md:p-7 border-[1.5px] border-encre bg-ivoire grid grid-cols-[auto_1fr_auto] gap-5 items-center">
          <span
            className="size-8.5 border-[1.5px] border-encre flex items-center justify-center font-medium text-encre shrink-0"
            aria-hidden="true"
          >
            ♥
          </span>
          <p className="text-sm leading-[1.4] m-0">
          ...
          <Btn variant="outline" href="#contact" className="shrink-0 text-[11px] hidden sm:inline-flex">
            En parler →
          </Btn>
        </AnimatedReveal>
      </div>
