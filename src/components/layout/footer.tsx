  ...
  return (
    <footer className="bg-encre text-ivoire pt-20 pb-10" role="contentinfo">
      <div className="max-w-[1280px] mx-auto px-5 md:px-10">
        {/* Top grid */}
        <div className="grid grid-cols-2 md:grid-cols-[2fr_1fr_1fr_1fr] gap-10 pb-16 border-b border-[rgba(245,241,232,.18)]">
          {/* Brand column */}
          <div className="col-span-2 md:col-span-1">
            <div className="flex items-center gap-2.5 text-[42px] font-medium tracking-[-0.03em] lowercase leading-none">
              <span className="w-3.5 h-3.5 rounded-full bg-coral flex-shrink-0" aria-hidden="true" />
              lumiron
            </div>
            <p className="mt-3.5 text-[14px] text-gris-light leading-[1.55] max-w-[36ch]">
              L'IA qui éclaire votre business. Agents conversationnels, outils sur-mesure, intégrations métier.
            </p>
          </div>
